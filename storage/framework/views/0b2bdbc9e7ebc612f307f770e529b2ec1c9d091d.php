	...
	<ul class="navbar-nav navbar-right">
		...
		<li class="dropdown navbar-user">
			...
			<div class="dropdown-menu dropdown-menu-right">
				...
				<a class="dropdown-item" style="cursor:pointer;" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
					Salir
				</a>
				<form id="logout-form" action="<?php echo e(route('logoutsop')); ?>" method="POST" style="display: none;">
					<?php echo csrf_field(); ?>
				</form>
			</div>
		</li>
...
<!-- end #header --><?php /**PATH C:\xampp\htdocs\DMPI\so-politica\resources\views/includes/header.blade.php ENDPATH**/ ?>