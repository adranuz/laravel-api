<?php $__env->startSection('title', 'Bootstrap Tour'); ?>
		...
		<div class="col-lg-4">
			...
			<div class="panel">
				<div class="panel-body">
					...
					<a href="javascript:;" class="btn btn-primary btn-sm"onclick="javascript:introJs().setOption('showProgress', true).start();" onclick="javascript:introJs().setOption('showProgress', true).start();">Demo</a>
				</div>
			</div>
			<!-- end panel -->
		</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DMPI\so-politica\resources\views/pages/ui-intro-js.blade.php ENDPATH**/ ?>