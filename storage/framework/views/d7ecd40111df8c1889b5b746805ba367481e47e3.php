...
&lt;/div&gt;</code></pre>
			...
			<div class="panel panel-inverse" data-sortable-id="ui-general-2">
				...
				<div class="panel-heading">
					...
					<h4 class="panel-title">Alerts Color</h4>
				</div>
				<!-- end panel-heading -->
				<!-- begin panel-body -->
				<div class="panel-body">
...
&lt;div class="alert alert-dark fade show"&gt;...&lt;/div&gt;</code></pre>
				</div>
				<!-- end hljs-wrapper -->
			</div>
			<!-- end panel -->
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DMPI\so-politica\resources\views/pages/ui-general.blade.php ENDPATH**/ ?>