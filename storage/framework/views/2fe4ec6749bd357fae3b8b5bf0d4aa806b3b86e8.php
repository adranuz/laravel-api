							...
							<div data-scrollbar="true" data-height="100%">
								...
								<ul class="list-group list-group-lg no-radius list-email">
									...
									<li class="list-group-item unread">
										...
										<a href="email_detail.html" class="email-user bg-gradient-purple">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', ['contentFullHeight' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DMPI\so-politica\resources\views/pages/email-inbox.blade.php ENDPATH**/ ?>